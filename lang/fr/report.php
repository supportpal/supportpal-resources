...
return array(
    ...
    "tickets_opened"            => "Billets ouverts",
    ...
    "operator_replies_desc"     => "La quantité de réponses à des billets par opérateur sur une période de temps.",
    "first_response_time"       => "Temps de première réponse",
    "first_response_time_desc"  => "Le temps qu'il a fallu aux opérateurs pour la première réponse à un billet ouvert.",
    ...
    "support_channels_desc"     => "Ce rapport indique le nombre de billets ouverts par chaque canal de support sur une période de temps donnée.",
    "ticket_by_department"      => "Billets par département",
    "ticket_by_department_desc" => "Le département que les billets sont ouverts sur une période de temps donnée.",
    "ticket_by_priority"        => "Billets par priorités",
    "ticket_by_priority_desc"   => "La priorité des billets ouverts pendant une période de temps donnée.",
    "ticket_by_status"          => "Billets par statut",
    "ticket_by_status_desc"     => "L'état actuel des billets ouverts sur une période de temps donnée.",
    "time_to_resolution"        => "Temps de résolution",
    "time_to_resolution_desc"   => "La quantité de temps qu'il a fallu pour un billet fermé après avoir été ouvert, ne comprend que des billets qui sont actuellement fermés.",
    "lt_1_day"                  => "<1 jour",
    "1-2_day"                   => "1-2 jours",
    "2-4_day"                   => "2-4 jours",
    "4-7_day"                   => "4-7 jours",
    ...
    "user_feedback_desc"        => "Les commentaires fournis par les utilisateurs sur les billets dans une période de temps donnée.",
    ...
    "ticket_by_organisation"    => "Billets par organisations",
